...
--local onNetGetFileOld = onNetGetFile; onNetGetFile = nil
	for i=1,#langs do
		...
		if res.headers and res.headers.status_code == 200 and files.exists("ux0:/data/abm/lang/"..langs[i].file..".txt") then
			files.copy("ux0:/data/abm/lang/"..langs[i].file..".txt","ux0:/ABM/lang/")
		else
			files.delete("ux0:/data/abm/lang/"..langs[i].file..".txt")
		end
		bubble_id = ""
